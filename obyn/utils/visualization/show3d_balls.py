...
if __name__=='__main__':
    np.random.seed(100)
    showpoints(np.random.randn(2500,3), np.random.choice(np.array(range(0,255)) * 1.0, size=(2500,3), replace=True), np.random.choice(np.array(range(0,255)) * 1.0, size=(2500,3), replace=True))
